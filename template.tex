...
\textcolor{blue}{MOTIVATION PARAGRAPH TO SAY WHY HIGH TEMPERATURE SENSING IS IMPORTANT, THINGS LIKE HEALTH MONITORING, ACTIVE CONTROL, DESIGN AND CERTIFICATION OF COMPONENT PROCESS AND VERIFICATION OF THE SYSTEM AT HIGH TEMPERATURE ENVIRONMENT}
...
This paper describes the development of a COMSOL model based on an experimental test setup used to monitor temperature using the propagation of ultrasonic Lamb waves. Direct comparison of results from the COMSOL model against the experimental results can be used to validate the model. 

\subsection{Short review on NGV temperature monitoring}

\textcolor{blue}{Please briefly talk about methods you covered in your papers, and cite your paper here.}
...
\textcolor{blue}{\subsection{Review of methods used to model harsh environment sensing}
Please add: Existing experiments and talk about the challenges in testing at high temperature and the accuracy of analytical methods at elevated temp}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{COMSOL simulation results}
