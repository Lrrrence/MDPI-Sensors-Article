...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{./figures/simpulse20csensors.eps}
    \caption{COMSOL simulation of $S_0$ mode propagation at room temperature.}\label{fig:COMSOLsimsignal}
\end{figure}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Experimental set up and experimental results}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.7\textwidth]{./figures/testdiagramsimple.eps}
    \caption{Cross-sectional diagram of total time-of-flight measurement setup.}\label{fig:testdiagramtotal}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=.6\textwidth]{./figures/w2wdiagram.eps}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.7\textwidth]{./figures/hjkhh7UmEx.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.7\textwidth]{./figures/s0andcomsolresult.eps}
