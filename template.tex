...
The $S_0$ Lamb wave mode has been targeted at a frequency-thickness product of 1 MHz-mm (in a 1 mm plate). The velocities extracted from dispersion curves can be seen plotted against experimental and simulated results in Figure~\ref{fig:s0result}.
...
The Lamb wave based monitoring system described in this paper is considered as a new method of online monitoring that can provide fast response times and a high level of accuracy without affecting component or engine operation. 
