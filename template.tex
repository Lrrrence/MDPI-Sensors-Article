...
\subsection{Potential applications of a ultrasonic temperature monitoring system}
...
It should be made clear, however, that the use of wedge transducers is unlikely to be the finalised transducer configuration for a permanently installed temperature monitoring system, as they rely on liquid couplants and acrylic wedges that would melt at relatively low temperatures. The use of wedges at this stage are useful for simplifying the signal processing techniques required, and targeting specific wave modes of interest.
...
The Lamb wave based monitoring system described in this paper is considered as a new method of online monitoring that can provide fast response times and a high level of accuracy without affecting component or engine operation. In order to apply this technology to nozzle guide vanes a number of challenges need to be addressed. The model developed in this study can be used to analyse the effect of curved surfaces, surface coatings, and cooling holes, on wave propagation. The reflections produced by cooling holes may enable temperature to be monitored at a number of different locations across the surface of the vane, which is highly advantageous for identifying temperature gradients and hotspots. Different Lamb wave modes can be targeted to determine the most suitable area of the frequency-thickness spectrum for temperature monitoring applications. 
...
\funding{This work was supported by Lloyds Register Foundation International Consortium of Nanotechnology and University of Southampton DTP fund.}
